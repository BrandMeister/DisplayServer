...
class CTransparentDataPort : public ISerialPort {
  public:
    CTransparentDataPort(bool enabled, const std::string& remoteaddress, unsigned int remoteport, const std::string& localaddress,
                         unsigned int localport, unsigned int frametype);
